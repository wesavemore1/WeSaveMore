...
import com.liferay.partner.info.service.PartnerLocalService;
...
/**
 * Provides the base implementation for the partner local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.partner.info.service.impl.PartnerLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.partner.info.service.impl.PartnerLocalServiceImpl
 * @generated
 */
public abstract class PartnerLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, PartnerLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PartnerLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.liferay.partner.info.service.PartnerLocalServiceUtil</code>.
	 */
	...
	public Partner addPartner(Partner partner) {
		...
		return partnerPersistence.update(partner);
	}
	...
	public Partner createPartner(long partnetId) {
		return partnerPersistence.create(partnetId);
	}
	...
	public Partner deletePartner(long partnetId) throws PortalException {
		return partnerPersistence.remove(partnetId);
	}
	...
	public Partner deletePartner(Partner partner) {
		return partnerPersistence.remove(partner);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Partner.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return partnerPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return partnerPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return partnerPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public Partner fetchPartner(long partnetId) {
		return partnerPersistence.fetchByPrimaryKey(partnetId);
	}
	...
	public Partner fetchPartnerByUuidAndGroupId(String uuid, long groupId) {
		return partnerPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public Partner getPartner(long partnetId) throws PortalException {
		return partnerPersistence.findByPrimaryKey(partnetId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(partnerLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Partner.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("partnetId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(Partner.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("partnetId");
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod<Partner>() {
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return partnerPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return partnerLocalService.deletePartner((Partner)persistedModel);
	}

	public BasePersistence<Partner> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return partnerPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<Partner> getPartnersByUuidAndCompanyId(
		...
		return partnerPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<Partner> getPartnersByUuidAndCompanyId(
		...
		return partnerPersistence.findByUuid_C(
	...
	public Partner getPartnerByUuidAndGroupId(String uuid, long groupId)
		...
		return partnerPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PartnerLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		partnerLocalService = (PartnerLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return PartnerLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = partnerPersistence.getDataSource();
